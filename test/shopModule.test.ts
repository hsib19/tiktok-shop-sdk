import { ShopModule } from '../src/modules/ShopModule';
...
describe('ShopModule', () => {
    ...
    describe('getAuthorizedShops', () => {
        it('should call request with correct params and return response', async () => {
            const mockResponse = { code: 0, data: { shops: [{ id: 'shop1' }] }, message: 'success' };
    ...
    describe('getCategoryAssets', () => {
        it('should call request with correct params and return response', async () => {
            const mockResponse = { code: 0, data: { assets: ['asset1', 'asset2'] }, message: 'success' };
            mockRequest.mockResolvedValue(mockResponse);
