...
import { authRequest } from '../src/client/AuthRequest'; // Adjust path if different
import { handleResponse } from '../src/utils/handleResponse'; // Adjust path if different
import { AccessTokenResponse, AuthRequestOptions } from '../src/types/AuthTypes'
...
jest.mock('../src/utils/handleResponse'); // Adjust path if different
