...
import { DeleteShopWebhookBody, UpdateShopWebhookBody } from '../src/types/EventTypes'
...
describe('EventModule', () => {
    ...
    describe('getShopWebhooks', () => {
        it('should call request with correct GET params and return response', async () => {
            const mockResponse = { code: 0, data: { webhooks: [{ id: 'wh1', event_type: 'order.create' }] }, message: 'success' };
    ...
    describe('updateShopWebhook', () => {
        it('should call request with correct PUT params and body, then return response', async () => {
            const body: UpdateShopWebhookBody = { event_type: 'ORDER_STATUS_CHANGE', address: 'https://example.com/webhook' };
            const mockResponse = { code: 0, message: 'updated successfully', data: {} };
            mockRequest.mockResolvedValue(mockResponse);
    ...
    describe('deleteShopWebhook', () => {
        it('should call request with correct DELETE params and body, then return response', async () => {
            ...
            const mockResponse = { code: 0, message: 'deleted successfully', data: {} };
            mockRequest.mockResolvedValue(mockResponse);
