...
export class AffiliateSellerModule {
     ...
     */
    async createConversationwithCreator(body: CreateConversationwithCreatorBody): Promise<TikTokAPIResponse<CreateConversationwithCreatorResponse>> {
        return this.request({
            method: "POST",
 ...
 */
    async createTargetCollaboration(body: CreateTargetCollaborationBody): Promise<TikTokAPIResponse<CreateTargetCollaborationResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async editOpenCollaborationSettings(body: EditOpenCollaborationSettingsBody): Promise<TikTokAPIResponse<EditOpenCollaborationSettingsResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async removeCreatorFromOpenCollaboration(params: RemoveCreatorFromOpenCollaborationParams): Promise<TikTokAPIResponse<RemoveCreatorFromOpenCollaborationResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async generateAffiliateProductPromotionLink(product_id: string): Promise<TikTokAPIResponse<GenerateAffiliateProductPromotionLinkResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async sellerSearchAffiliateOpenCollaborationProduct(params: SellerSearchAffiliateOpenCollaborationProductParams): Promise<TikTokAPIResponse<SellerSearchAffiliateOpenCollaborationProductResponse>> {
        return this.request({
            method: "POST",
 ...
 */
    async searchSellerAffiliateOrders(params: SearchSellerAffiliateOrdersParams): Promise<TikTokAPIResponse<SearchSellerAffiliateOrdersResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async sellerSearchSampleApplicationsFulfillments(params: SellerSearchSampleApplicationsFulfillmentsParams): Promise<TikTokAPIResponse<SellerSearchSampleApplicationsFulfillmentsResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async sellerReviewSampleApplications(params: SellerReviewSampleApplicationsParams): Promise<TikTokAPIResponse<SellerReviewSampleApplicationsResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async getOpenCollaborationSampleRules(query: GetOpenCollaborationSampleRulesQuery): Promise<TikTokAPIResponse<GetOpenCollaborationSampleRulesResponse>> {
        return this.request({
            method: "GET",
     ...
     */
    async sellerSearchSampleApplications(params: SellerSearchSampleApplicationsParams): Promise<TikTokAPIResponse<SellerSearchSampleApplicationsResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async editOpenCollaborationSampleRule(body: EditOpenCollaborationSampleRuleBody): Promise<TikTokAPIResponse<EditOpenCollaborationSampleRuleResponse>> {
        return this.request({
            method: "POST",
            path: `/affiliate_seller/202410/open_collaborations/sample_rules`,
            body: body,
 ...
 */
    async removeTargetCollaboration(target_collaboration_id: string): Promise<TikTokAPIResponse<object>> {
        return this.request({
            method: "DELETE",
     ...
     */
    async searchTargetCollaborations(params: SearchTargetCollaborationsParams): Promise<TikTokAPIResponse<SearchTargetCollaborationsResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async updateTargetCollaboration(params: UpdateTargetCollaborationParams): Promise<TikTokAPIResponse<UpdateTargetCollaborationResponse>> {
        return this.request({
            method: "PUT",
     ...
     */
    async getOpenCollaborationSettings(): Promise<TikTokAPIResponse<GetOpenCollaborationSettingsResponse>> {
        return this.request({
            method: "GET",
     ...
     */
    async removeOpenCollaboration(product_id: string): Promise<TikTokAPIResponse<RemoveOpenCollaborationResponse>> {
        return this.request({
            method: "DELETE",
     ...
     */
    async queryTargetCollaborationDetail(target_collaboration_id: string): Promise<TikTokAPIResponse<QueryTargetCollaborationDetailResponse>> {
        return this.request({
            method: "GET",
 ...
 */
    async getOpenCollaborationCreatorContentDetail(query: GetOpenCollaborationCreatorContentDetailQuery): Promise<TikTokAPIResponse<GetOpenCollaborationCreatorContentDetailResponse>> {
        return this.request({
            method: "GET",
     ...
     */
    async searchOpenCollaboration(params: SearchOpenCollaborationParams): Promise<TikTokAPIResponse<SearchOpenCollaborationResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async createOpenCollaboration(body: CreateOpenCollaborationBody): Promise<TikTokAPIResponse<CreateOpenCollaborationResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async getMessageInTheConversation(params: GetMessageInTheConversationParams): Promise<TikTokAPIResponse<GetMessageInTheConversationResponse>> {
        return this.request({
            method: "GET",
     ...
     */
    async getConversationList(params: GetConversationListParams): Promise<TikTokAPIResponse<GetConversationListResponse>> {
        return this.request({
            method: "GET",
            path: `/affiliate_seller/202412/conversations`,
            query: params.query,
     ...
     */
    async sendImMessage(params: SendImMessageParams): Promise<TikTokAPIResponse<SendImMessageResponse>> {
        return this.request({
            method: "POST",
 ...
 */
     ...
     */
    async markConversationRead(body: MarkConversationReadBody): Promise<TikTokAPIResponse<MarkConversationReadResponse>> {
        return this.request({
            method: "POST",
     ...
     */
    async getLatestUnreadMessages(): Promise<TikTokAPIResponse<GetLatestUnreadMessagesResponse>> {
        return this.request({
            method: "GET",
     ...
     */
    async sellerSearchCreatorOnMarketplace(params: SellerSearchCreatorOnMarketplaceParams): Promise<TikTokAPIResponse<SellerSearchCreatorOnMarketplaceResponse>> {
        return this.request({
            method: "POST",
            path: `/affiliate_seller/202412/conversations/messages/list/newest`,
            query: params.query,
     ...
     */
    async getMarketplaceCreatorPerformance(creator_user_id: string): Promise<TikTokAPIResponse<GetMarketplaceCreatorPerformanceResponse>> {
        return this.request({
            method: "GET",
