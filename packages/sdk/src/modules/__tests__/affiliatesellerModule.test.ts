...
describe('AffiliateSellerModule', () => {
    ...
    it('calls generateAffiliateProductPromotionLink with correct path', async () => {
        ...
        const result = await affiliateModule.generateAffiliateProductPromotionLink(product_id);
    ...
    it('calls removeCreatorFromOpenCollaboration with correct path and body', async () => {
        ...
        const result = await affiliateModule.removeCreatorFromOpenCollaboration(params);
    ...
    it('calls sellerSearchAffiliateOpenCollaborationProduct with correct path, query, and body', async () => {
        ...
        const result = await affiliateModule.sellerSearchAffiliateOpenCollaborationProduct(params);
    ...
    it('calls sellerSearchSampleApplicationsFulfillments with correct path and body', async () => {
        ...
        const result = await affiliateModule.sellerSearchSampleApplicationsFulfillments(params);
    ...
    it('calls getOpenCollaborationSampleRules with correct path and query', async () => {
        const query: GetOpenCollaborationSampleRulesQuery = { product_ids: ['product_1'] };
    ...
    it('calls removeTargetCollaboration with correct path', async () => {
        ...
        const result = await affiliateModule.removeTargetCollaboration(target_collaboration_id);
    ...
    it('calls queryTargetCollaborationDetail with correct path', async () => {
        ...
        const result = await affiliateModule.queryTargetCollaborationDetail(target_collaboration_id);
    ...
    it('calls getOpenCollaborationCreatorContentDetail with correct path and query', async () => {
        const query: GetOpenCollaborationCreatorContentDetailQuery = { page_size: 1, product_id: "094203490234" };
        ...
        const result = await affiliateModule.getOpenCollaborationCreatorContentDetail(query);
    ...
    it('calls getMessageInTheConversation with correct path and query', async () => {
        const params: GetMessageInTheConversationParams = { conversation_id: 'conv_123', query: { page_size: 20 } };
    ...
    it('calls getConversationList with correct path, query, and body', async () => {
        const params: GetConversationListParams = { query: { page_size: 1 }, body: { 
            only_need_conversation_id: true
         } };
    ...
    it('calls sendImMessage with correct path and body', async () => {
        const params: SendImMessageParams = { conversation_id: 'conv_123', body: { 
    ...
    it('calls createConversationWithCreator with correct path and body', async () => {
        const body: CreateConversationWithCreatorBody = { creator_id: 'user_123', only_need_conversation_id: true };
    ...
    it('calls sellerSearchCreatorOnMarketplace with correct path, query, and body', async () => {
        const params: SellerSearchCreatorOnMarketplaceParams = { query: { page_size: 10 }, body: { 
        ...
        mockRequest.mockResolvedValueOnce(expectedResponse);
        const result = await affiliateModule.sellerSearchCreatorOnMarketplace(params);
    ...
    it('calls getMarketplaceCreatorPerformance with correct path', async () => {
        ...
        mockRequest.mockResolvedValueOnce(expectedResponse);
        const result = await affiliateModule.getMarketplaceCreatorPerformance(creator_user_id);
