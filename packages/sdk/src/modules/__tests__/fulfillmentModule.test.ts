...
import { ApiResponse, CombinablePackageBody, CombinePackageResponse, CreateFirstMileBundleBody, CreateFirstMileBundleResponse, CreatePackageBody, CreatePackagesResponse, GetEligibleShippingServiceInput, GetEligibleShippingServiceResponse, GetOrderSplitAttributesQuery, GetOrderSplitAttributesResponse, GetPackageHandoverTimeSlotsResponse, RequestFunction, SearchCombinablePackagesQuery, SearchCombinablePackagesResponse, SearchPackageInput, SearchPackageResponse, SplitOrdersQuery, SplittableGroupsResponse, TikTokAPIResponse, UncombinePackagesBody, UncombinePackagesResponse } from '@types';
...
describe('FulfillmentModule', () => {
    ...
    it('should call getOrderSplitAttributes with correct params', async () => {
        const params: GetOrderSplitAttributesQuery = { order_ids: ['02503490534545'] };
    ...
    it('should call splitOrders with correct params', async () => {
        ...
        const mockResponse: TikTokAPIResponse<SplittableGroupsResponse> = { data: {
            packages: [
                {
        ...
        }, code: 0, message: 'success', request_id: "3948579385394545" };
        mockRequest.mockResolvedValueOnce(mockResponse);
    ...
    it('should call getEligibleShippingService correctly', async () => {
        ...
        const mockResponse: TikTokAPIResponse<GetEligibleShippingServiceResponse> = { data: {
        ...
        }, code: 0, message: 'Success', request_id: "3498573894534" };
        mockRequest.mockResolvedValueOnce(mockResponse);
    ...
    it('should call searchCombinablePackages correctly', async () => {
        ...
        const mockResponse: TikTokAPIResponse<SearchCombinablePackagesResponse> = { data: {
            combinable_packages: [
                {
                    id: "57466538837665",
                    order_ids: [
            ...
            "total_count": 10
        }, code: 0, message: 'Success', request_id: "398573945345" };
        mockRequest.mockResolvedValueOnce(mockResponse);
