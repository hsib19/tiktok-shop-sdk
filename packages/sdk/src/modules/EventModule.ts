import { ApiResponse, DeleteShopWebhookBody, GetWebhooksResponse, RequestFunction, UpdateShopWebhookBody, TikTokAPIResponse } from "@types";
...
export class EventModule {
     ...
     */
    async updateShopWebhook(body: UpdateShopWebhookBody): Promise<TikTokAPIResponse<ApiResponse>> {
        return this.request({
            method: 'PUT',
            path: '/event/202309/webhooks',
            body
     ...
     */
    async deleteShopWebhook(body: DeleteShopWebhookBody): Promise<TikTokAPIResponse<ApiResponse>> {
        return this.request({
            method: 'DELETE',
            path: '/event/202309/webhooks',
            body
