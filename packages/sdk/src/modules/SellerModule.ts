import { SellerShopsResponse, SellerPermissionsResponse, RequestFunction, TikTokAPIResponse } from "@types";
...
export class SellerModule {
     ...
     */
    async getSellerPermissions(): Promise<TikTokAPIResponse<SellerPermissionsResponse>> {
        return this.request({
            method: 'GET',
