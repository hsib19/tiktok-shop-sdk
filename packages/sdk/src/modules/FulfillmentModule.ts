...
export class FulfillmentModule {
     ...
     */
    getOrderSplitAttributes(params: GetOrderSplitAttributesQuery): Promise<TikTokAPIResponse<GetOrderSplitAttributesResponse>> {
        return this.request({
            method: 'GET',
     ...
     */
    splitOrders(params: SplitOrdersQuery): Promise<TikTokAPIResponse<SplittableGroupsResponse>> {
        return this.request({
            method: 'POST',
     ...
     */
    getEligibleShippingService(params: GetEligibleShippingServiceInput): Promise<TikTokAPIResponse<GetEligibleShippingServiceResponse>> {
        return this.request({
            method: 'POST',
     ...
     */
    searchPackage(params: SearchPackageInput): Promise<TikTokAPIResponse<SearchPackageResponse>> {
        return this.request({
            method: 'POST',
     ...
     */
    createPackage(params: CreatePackageBody): Promise<TikTokAPIResponse<CreatePackagesResponse>> {
        return this.request({
            method: 'POST',
     ...
     */
    createFirstMileBundle(params: CreateFirstMileBundleBody): Promise<TikTokAPIResponse<CreateFirstMileBundleResponse>> {
        return this.request({
            method: 'POST',
     ...
     */
    searchCombinablePackages(params: SearchCombinablePackagesQuery): Promise<TikTokAPIResponse<SearchCombinablePackagesResponse>> {
        return this.request({
            method: 'GET',
     ...
     */
    combinablePackage(params: CombinablePackageBody): Promise<TikTokAPIResponse<CombinePackageResponse>> {
        return this.request({
            method: 'POST',
     ...
     */
    uncombinePackages(params: UncombinePackagesBody): Promise<TikTokAPIResponse<UncombinePackagesResponse>> {
        return this.request({
            method: 'POST',
     ...
     */
    getPackageHandoverTimeSlots(package_id: string): Promise<TikTokAPIResponse<GetPackageHandoverTimeSlotsResponse>> {
        return this.request({
            method: 'GET',
