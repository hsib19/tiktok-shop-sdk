...
export class FinanceModule {
     ...
     */
    getStatements(params: GetStatementsQuery): Promise<TikTokAPIResponse<GetStatementsResponse>> {
        return this.request({
            method: 'GET',
     ...
     */
    getPayments(params: GetPaymentsQuery): Promise<TikTokAPIResponse<GetPaymentsResponse>> {
        return this.request({
            method: 'GET',
     ...
     */
    getWithdrawals(params: GetWithdrawalsQuery): Promise<TikTokAPIResponse<GetPaymentsResponse>> {
        return this.request({
            method: 'GET',
     ...
     */
    getTransactionsByOrder(order_id: string): Promise<TikTokAPIResponse<GetTransactionsByOrderResponse>> {
        return this.request({
            method: 'GET',
     ...
     */
    getTransactionsByStatement(params: GetTransactionsByStatementsInput): Promise<TikTokAPIResponse<GetTransactionsByOrderResponse>> {
        return this.request({
            method: 'GET',
