...
export async function main() {
  try {
    ...
    const response = await sdk.product.createGlobalProduct({
      title:
      ...
      skus: [
        {
          ...
          sku_unit_count: '1',
          extra_identifier_codes: ['10000000000000'],
      ...
      category_version: 'v1',
      responsible_person_ids: ['67726293bf1eb1e92401a'],
      manufacturer_ids: ['67726293bf1eb1e92401a'],
      source_locale: 'de-DE',
...
// npm exec tsx apps/examples/src/product/createGlobalProduct.ts
