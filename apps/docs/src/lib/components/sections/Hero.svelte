...
<section class="mb-3 w-full bg-white pt-23 md:pt-45 md:pb-10 dark:bg-neutral-950">
	<div
		...
		>
			<pre class="whitespace-pre-wrap text-neutral-800 dark:text-neutral-100"><code
					><span class="text-purple-600">import</span> &#123; <span class="text-blue-500"
						>TikTokShopSDK</span
					>&#125; <span class="text-purple-600">from</span> <span class="text-rose-500"
						>'tiktok-shop-sdk'</span
					>;
