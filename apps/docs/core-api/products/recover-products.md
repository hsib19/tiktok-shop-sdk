...
- Use `product.recoverProduct()` from the SDK

**Official documentation:** [TikTok Shop – Recover Products](https://partner.tiktokshop.com/docv2/page/recover-products-202309)
...
Full reference:  
[TikTok Common Errors](https://partner.tiktokshop.com/docv2/page/recover-products-202309#Error_Code)
