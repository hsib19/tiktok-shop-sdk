...
export interface AddExternalOrderReferencesBody extends Record<string, unknown> {
...
export interface GetExternalOrderReferencesParams extends Record<string, unknown> {
    order_id: string;
    query: {
        platform: string;
    };
