import { AuthorizedShopsResponse, CategoryAssetsResponse, RequestFunction, TikTokAPIResponse } from "@types";
...
export class ShopModule {
     ...
     */
    async getAuthorizedShops(): Promise<TikTokAPIResponse<AuthorizedShopsResponse>> {
        return this.request({
            method: 'GET',
     ...
     */
    async getCategoryAssets(): Promise<TikTokAPIResponse<CategoryAssetsResponse>> {
        return this.request({
            method: 'GET',
